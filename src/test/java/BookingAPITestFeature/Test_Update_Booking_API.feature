Feature: Test Update Booking API
  ...
  @smoke @regression
  Scenario: Test Update Booking API
    # Creating User ----------------------------->
    Given path "booking"
    ...
    * set createRequestPayload.firstname = "Ram"
    * set createRequestPayload.lastname =  "Sharma"
    * set createRequestPayload.totalprice = 245
    And request createRequestPayload
    When method put
    Then status 200
    * def firstname = createRequestPayload.firstname
